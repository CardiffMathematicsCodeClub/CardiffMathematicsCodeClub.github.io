...
dependencies installed. This repository
uses the [Bundle](http://bundler.io/) ruby gem to manage it's dependencies. To
install bundle run the following
...
`Fork` button in upper right part
...
own fork of this repository. You make
changes to you fork and then make a pull request against this repository
containing your changes.

But before you do *please* run the tests locally by running the following
command from the same folder as the README
```
$ rake
```
### Draft Posts
...
Jekyll you can simply add the following to the markdown for that particular page
